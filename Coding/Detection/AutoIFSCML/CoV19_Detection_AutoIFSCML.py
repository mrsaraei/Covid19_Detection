...
print("Project: AutoIFSCML: Automatic Comparative Machine Learning based on Important Features in COVID-19 Detection Model")
...
df = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Annotated Data\CoV19_Data_Annotated.csv")
...
pd.DataFrame(f).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\f.csv", index = False)
pd.DataFrame(t).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\t.csv", index = False)
...
df_f = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\f.csv")
df_t = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\t.csv")
...
pd.DataFrame(df).to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\df.csv", index = False)
...
# Import DataFrame (.csv) by Pandas Library
df = pd.read_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\CoV19 Dataset\Detection\Prepared Data [IF]\df.csv")
...
df_feat.to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\Results\Detection\Important Features\AutoFS.csv", index = False)
...
df_CML.to_csv(r"D:\My Papers\2020 - 2030\Journal Paper\Journal of Communications Technology and Electronics [IF=0.5] (2022)\Results\Detection\Important Features\AutoIFSCML.csv", index = False)
print("")
